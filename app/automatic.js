...
if (vers.beta) {
    ...
    log.warn("https://bitbucket.org/jessecar/backpack.tf-automatic/downloads");
    ...
    log.warn("https://bitbucket.org/jessecar/backpack.tf-automatic/issues?status=new&status=open")
}
...
Utils.getJSON({
    url: "https://bitbucket.org/jessecar/backpack.tf-automatic/raw/master/package.json"
}).then(([body]) => {
    if (!body.version) {
    ...
    if (latestv > curv) {
        ...
        log.info("Download it here: https://bitbucket.org/jessecar/backpack.tf-automatic/downloads");
        log.info("===================================================");
    }
}).catch((msg) => {
